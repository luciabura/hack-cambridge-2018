...
public class NFCDisplayActivity extends Activity {
    ...
    protected void onResume(){
        //Log.w("On Resume", "Went into On Resume");
        super.onResume();
        ...
        if (NfcAdapter.ACTION_NDEF_DISCOVERED.equals(intent.getAction())) {
            ...
            //Log.w("Message received", "Just received a message.");
    ...
    public void populateList(Model[] menuItems) {
        ...
        if(CustomAdapter.me != null) {
            Log.w("Adapter.me...not null", "before");
        }
        else {
            Log.w("Adapter.me was null", "before");
        }
        CustomAdapter.me = adapter;
        if(CustomAdapter.me != null) {
            Log.w("After adapter.me", "after");
        }
        else {
            Log.w("Adapter.me was null", "after");
        }
